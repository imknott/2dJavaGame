...
import static soulsvania.utils.Constants.UI.URMButtons.URM_SIZE;
...
public class GameOverLay {
    ...
    private functionButtons menu, play;
    ...
    private void createButtons() {
        ...
        play = new functionButtons(playX, y, URM_SIZE, URM_SIZE, 0);
        menu = new functionButtons(menuX, y, URM_SIZE, URM_SIZE, 2);

    }

    private void createImg() {
        img = LoadSave.setup("randomimages/death_screen");
